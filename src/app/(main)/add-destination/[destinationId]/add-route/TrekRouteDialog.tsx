      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-4xl">
        ...
        <div className="bg-muted/50 mb-4 rounded-lg p-3">
          <div className="mb-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Badge variant="secondary" className="max-sm:ml-6">Trek Route</Badge>
          </div>
          ...
          <Card className="gap-3">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between py-1">
                ...
                <Badge variant={trekData.teahouses ? "default" : "secondary"}>
                  {trekData.teahouses ? "Available" : "Not Available"}
                </Badge>
              </div>
            </CardContent>
          </Card>
        ...
        {trekData.safetyTips.length > 0 && (
          <Card className="mt-4 border-blue-200 dark:border-blue-800/60 gap-3">
            <CardHeader className="pb-2">
            ...
            <CardContent>
              <div className="space-y-2">
                {trekData.safetyTips.map((tip, index) => (
                  <div
                    key={index}
                    className="flex items-start gap-2 rounded bg-blue-50 dark:bg-blue-950/40 p-2 text-sm"
                  >
                    <Shield className="mt-0.5 h-3 w-3 flex-shrink-0 text-blue-600 dark:text-blue-400" />
                    <span className="text-blue-800 dark:text-blue-200/80">{tip}</span>
                  </div>
                ))}
              </div>
            </CardContent>
