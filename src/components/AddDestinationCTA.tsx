...
const AddDestinationCTA = () => {
  return (
    <section
      className="my-14 mt-4 scroll-mt-20 px-4 sm:px-8 md:px-14 lg:px-20"
      id="add-destination"
    >
      <h2 className="mb-6 text-2xl font-bold">Share your hidden gems</h2>
      <div className="bg-muted relative w-full overflow-hidden rounded-lg p-10">
