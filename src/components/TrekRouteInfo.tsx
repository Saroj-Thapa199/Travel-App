...
const TrekRouteInfo = ({trekData}: TrekRouteInfoProps) => {
  return (
    <div className="">
        {/* Trek Summary */}
            ...
            <Card className="gap-3">
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center justify-between py-1">
                  ...
                  <Badge
                    variant={
                      trekData.teahouses.available ? "default" : "secondary"
                    }
                  >
                    {trekData.teahouses.available ? "Yes" : "No"}
                  </Badge>
          ...
          {trekData.safetyTips.length > 0 && (
            <Card className="mt-4 gap-3 border-blue-200 dark:border-blue-800/60">
              <CardHeader className="pb-2">
